...
public class DES3 {
    ...
    // Constructor for DES3 class
    public DES3(String plaintext, String key, String inversePlaintext, String inverseKey) {
    ...
    public void encryptDES(String plaintext, String inversePlaintext, String key,String inverseKey) {
        ...
        for (int i = 0; i < 16; i++) {
            ...
            String newRightInv = functionXOR(leftInv, sBoxOutputInv);
            ...
            String newRightIvKy = functionXOR(leftPlainInv, sBoxOutputIvKy);
    ...
    // returns a key thats been shifted left and permuted using the PC2 table for a specific round
    private static String pc2KeyRound(String pc1Key, int[] pc2, int round) {
        StringBuilder pc2Key = new StringBuilder();

        // Split the key into two halves then perform left shift
        String cKey = pc1Key.substring(0, 28);
        String dKey = pc1Key.substring(28, 56);
